import{r as c,c as we,g as Be,j as u,M as k,au as Oe}from"./cg166fqqcxkeiosv.js";import{B as Ve,dv as je,cN as qe,ht as We,ai as Ge,H as He,fO as R,gf as Xe,ab as fe,dh as Ke,w as $e,cZ as Ye,hu as Ze,bI as Je,h1 as Qe,gH as en,bb as ie,bx as _e,d as U,bT as q,df as me,b4 as nn,r as ve,q as ge,ch as tn,P as on,d7 as an,D as sn,c3 as rn}from"./mwlpozqwnbys03vp.js";import{d6 as Te,z as cn,nu as ln,d as un,i as dn,g7 as fn,n as mn,jd as vn}from"./d5k5wa3zyqlgc9bk.js";import{u as gn}from"./h73vs9mo3wx5w4z2.js";import{a as De,m as pn,u as Me,c as hn,d as bn,e as xn,s as Z,f as J,g as Sn,h as An,i as yn,j as Re,k as ke,X as Cn,l as wn,T as Q}from"./injyhirdj1cdrzbe.js";import{b as _n}from"./ehrl4h7p8z26p31l.js";const Tn=()=>{const t=Ve(),e=De(),n=c.useCallback(()=>e.getState().isVoiceModeActive,[e]);return c.useMemo(()=>new Proxy(t,{get(a,o){const r=a[o];return n()||o==="closeAll"?r:()=>{}}}),[n,t])},Dn=()=>{const t=je()&&qe,e=Ge("1359128927")?.value;return async()=>{if(t&&e)return await We();try{const n=await navigator.mediaDevices.getUserMedia({audio:!0,video:!1}),a=await navigator.mediaDevices.enumerateDevices();return n.getTracks().forEach(r=>r.stop()),a.some(r=>r.kind==="audioinput"&&r.label!=="")}catch(n){if(!pn(n))throw n;return!1}}};function Nt(t){return{conversation_id:t.serverThreadId,parent_message_id:t.parentMessageId,voice_mode:t.isAdvancedMode?"advanced":"standard",eventSource:t.eventSource,clientThreadId:t.clientThreadId,gizmo_id:t.gizmoId,voice:t.voice}}function Mn({requestMicPermissions:t}={requestMicPermissions:!1}){const e=we(),n=De(),a=Tn(),{voiceName:o,voiceMainLanguage:r,voiceTrainingAllowed:s,videoTrainingAllowed:l}=Te(),g=Me(d=>d.isVoiceModeActive),p=hn(),{room:h}=bn(),v=xn(),m=Dn(),i=He(),b=e.formatMessage({id:"useVoiceModeButtonAction.error",defaultMessage:"Failed to start voice mode"}),A=c.useCallback(async()=>{p&&(await h?.disconnect(),Z(null,n),n.setState(d=>{d.server.remoteState=J.Halted}))},[p,h,n]);return{startVoiceMode:c.useCallback(async d=>{p&&(await h?.disconnect(),Z(null,n)),t&&await m();const x=await Sn("audioinput");n.setState(y=>{y.audioInputDevice=x,y.isVoiceModeActive=!0,y.voiceMode=d.voice_mode,y.server.remoteState=J.Connecting});const S=performance.now(),C=[8,4,4,4,12].map(y=>Math.floor(Math.random()*Math.pow(10,y)).toString(16).padStart(y,"0").toUpperCase()).join("-");try{R.livekit.connectCalled();const y=await v({conversation_id:d.conversation_id??null,requested_voice_mode:d.voice_mode??null,gizmo_id:d.gizmo_id??null,voice:d.voice,requested_default_model:d.requested_default_model??null},d.eventSource),{default_voice_mode:T,modes:D,chatreq:F}=y;performance.mark("livekit.start"),performance.mark("voice_mode.start");const{eventSource:H,voice:B,clientThreadId:X,voice_mode:E,gizmo_id:K,...O}=d,P=D.find(j=>j.mode===T);if(!P)throw new Error("No voice status mode found for default mode "+T);const V=P.default_model_slug,I=T==="advanced"?V:void 0,$=F?await Xe.getEnforcementToken(F):null,Y=d.gizmo_id?{kind:fe.GizmoInteraction,gizmo_id:d.gizmo_id}:{kind:fe.PrimaryAssistant},M=await An.getVoiceToken({...O,voice:B??o,language_code:r,voice_session_id:C,timezone_offset_min:new Date().getTimezoneOffset(),voice_mode:T,model_slug:V,model_slug_advanced:I,chatreq_token:F?.token,history_and_training_disabled:i,conversation_mode:Y,voice_training_allowed:s,video_training_allowed:l},d.eventSource,$);M&&M.token&&M.url&&M.e2ee_key&&(cn.setState({lastVoiceSessionStartTime:new Date}),Z({conversationId:d.conversation_id??d.clientThreadId,voiceSessionId:C,voiceMode:M.voice_mode_decision.voice_mode,credentials:{...M,e2eeKey:M.e2ee_key}},n)),performance.mark("livekit.end"),R.livekit.success({durationMs:performance.measure("livekit","livekit.start","livekit.end").duration.toFixed(0),voice_session_id:C}),R.connectionLatency.success({durationMs:performance.now()-S})}catch(y){const T=yn(n.getState());throw R.livekit.failure(y,{...T,voice_session_id:C,eventSource:d.eventSource,voice:d.voice??"(undefined)",requested_voice_mode:d.voice_mode??"(undefined)",gizmo_id:d.gizmo_id??"(undefined)"}),Re.debug("failed to get voice token",y),n.setState(D=>{D.server.remoteState=J.Halted}),R.connectionLatency.failure({durationMs:performance.now()-S}),a.danger(b),y}},[m,b,v,p,i,t,h,a,l,r,o,n,s]),stopVoiceMode:A,isConnected:p,isVoiceModeActive:g}}const Rn=2,kn=({viewport:t,canvasSize:e,shouldMeasurePerf:n,source:a})=>{const o=c.useRef({}),r=c.useCallback(s=>{const l=s.getExtension("WEBGL_debug_renderer_info");l&&(o.current.vendor=s.getParameter(l.UNMASKED_VENDOR_WEBGL),o.current.renderer=s.getParameter(l.UNMASKED_RENDERER_WEBGL))},[]);return c.useEffect(()=>{const s={vendor:o.current.vendor??"(unavailable)",renderer:o.current.renderer??"(unavailable)",width:t[0],height:t[1],canvasWidth:e[0],canvasHeight:e[1],dpr:window.devicePixelRatio,source:a};!Ke(s,o.current)&&n&&(o.current=s,ke(Rn).then(g=>{R.bloop.performance({...s,fps:g})}))},[e,n,t,a]),r},Fn=.25,En=3,pe=28,ee=55,ne=200,he=1.1,Pn=({viewport:t,initialScale:e,shouldCalibrate:n})=>{const[a,o]=c.useState(e),r=c.useRef(void 0),s=c.useRef(void 0),l=c.useRef(void 0),g=c.useRef("down"),p=c.useCallback(()=>{const h=g.current==="up"?En:Fn;ke(h).then(v=>{if(v<pe){g.current="down";const m=Math.max(v,1),i=Math.sqrt(m/pe);o(b=>b*i),s.current=window.setTimeout(p,ne)}else if(l.current){const m=v>=ee,i=v>=l.current*he;if(m||i)g.current="up",o(b=>b*he),s.current=window.setTimeout(p,ne);else if(v<ee){g.current="down";const b=Math.sqrt(v/ee);o(A=>A*b)}}l.current=v})},[]);return c.useEffect(()=>{const[h,v]=t,[m,i]=r.current??[];return n&&(m!==h||i!==v)&&(r.current=t,clearTimeout(s.current),o(e),s.current=window.setTimeout(p,ne)),()=>{clearTimeout(s.current)}},[n,p,e,t]),a},In=60,G=Math.floor(1e3/In);var zn=$e,Ln=Ye;function Nn(t){return Ln(t)&&zn(t)}var Un=Nn,Bn=Ze,On=Je,Vn=Qe,jn=en,qn=Un,Wn=Math.max;function Gn(t){if(!(t&&t.length))return[];var e=0;return t=Bn(t,function(n){if(qn(n))return e=Wn(n.length,e),!0}),jn(e,function(n){return On(t,Vn(n))})}var Hn=Gn,Xn=ln,Kn=Hn,$n=Xn(Kn),Yn=$n;const te=Be(Yn),se=240,Fe=2048,Ee=new Array(se).fill(0),Zn=t=>{const e=Cn(t,{bands:se,updateInterval:G,loPass:0,hiPass:400,analyserOptions:{fftSize:Fe}});return e.length===0?Ee:e},re=t=>{const{magnitudes:e,binCount:n,gainMultiplier:a}=t;if(e.length===0)return new Array(n).fill(0);const o=Math.ceil(e.length/n),r=[];for(let s=0;s<e.length;s+=o){const l=Math.min(s+o,e.length),g=e.slice(s,l).sort((m,i)=>m-i),p=Math.floor(g.length/2);let h;g.length%2===0?h=(g[p-1]+g[p])/2:h=g[p],h=Math.abs(h),h*=a;const v=h/(h+1);r.push(v)}return r},Pe=(t,e)=>{const n=e.sampleRate,a=t.length,o=e.bandCount,r=e.binCount,s=e.gainMultipliers;if(s.length!==o)throw new Error("gainMultipliers must have length equal to bandCount");const l=a*2,g=n/l,p=t.map((b,A)=>A*g),h=20,v=n/2,m=new Array(o+1).fill(0).map((b,A)=>h*Math.pow(v/h,A/o)),i=new Array(o).fill(null).map(()=>[]);for(let b=0;b<p.length;b+=1)for(let A=0;A<o;A+=1)if(p[b]>=m[A]&&p[b]<m[A+1]){i[A].push(t[b]);break}for(let b=0;b<o;b+=1){const A=i[b],f=s[b];i[b]=re({magnitudes:A,binCount:r,gainMultiplier:f})}return i},be=60,Ie=48e3,Jn=1,Qn=2,et=40,nt=2;function xe({time:t,timeConstant:e}){return 1-Math.exp(-t/e)}function Se(t,e){const n=e[1]-e[0];return e[0]+t*n}const oe=t=>{if(!Array.isArray(t)||t.length!==2||typeof t[0]!="number"||typeof t[1]!="number")throw new Error("zip failed - received a value that is not a [number, number] tuple")},tt=t=>{const{prevAudioData:e,prevCumulativeAudioData:n,deltaTimeS:a,audioDataRaw:o}=t,r=o.map(m=>m*a*be*Jn),s=xe({time:a,timeConstant:Qn}),l=te(e,r).map(m=>(oe(m),Se(s,m))),g=o.map(m=>m*a*be*et),p=te(n,g).map(m=>(oe(m),m[0]+m[1])),h=xe({time:a,timeConstant:nt}),v=te(n,p).map(m=>(oe(m),Se(h,m)));return{audioData:l,cumulativeAudioData:v}},Ut=(t,e)=>{const n=Zn(t),a=Pe(n,{sampleRate:Ie,binCount:e.bins,bandCount:e.bands,gainMultipliers:e.gainMultipliers}),o=re({magnitudes:n,binCount:1,gainMultiplier:1});return{bandMagnitudes:a,cumulativeMagnitude:o}};function ot(t){const e=c.useRef(t);e.current=t;const[n,a]=c.useState(null),o=c.useCallback(r=>{a(r)},[]);return ie(()=>{const r=new ResizeObserver(s=>{for(const l of s)e.current(l)});return n&&r.observe(n),()=>{r.disconnect()}},[n]),o}const L=Re.createChild("GLCanvas");function at({className:t,vert:e,frag:n,Behaviors:a,onViewportUpdate:o,onRenderComplete:r,onGlAvailable:s,onCanvasSizeUpdate:l,scale:g}){const p=c.useRef(null),h=c.useRef(null),[v,m]=c.useState(null),[i,b]=c.useState(),A=c.useRef(un(x=>{const{width:S,height:C}=x.contentRect,y=Math.floor(Math.min(S??0,C??0));m(y),o?.({width:y,height:y})},100)),f=ot(A.current);if(ie(()=>{const x=p.current,{width:S,height:C}=x??{};if(x&&v!=null&&S&&C){const y=x.getContext("webgl2",{premultipliedAlpha:!0});y?b(y):L.error("webgl2 context not supported")}},[v]),ie(()=>{if(!i)return;const x=i.createProgram(),S=i.createShader(i.VERTEX_SHADER),C=i.createShader(i.FRAGMENT_SHADER);if(!x){L.debug("failed to create program");return}if(!S||!C){L.debug("failed to create shaders",S,C);return}let y="";if(i.shaderSource(S,e),i.compileShader(S),y+=`vertShader:
${i.getShaderInfoLog(S)}
`,i.attachShader(x,S),i.shaderSource(C,n),i.compileShader(C),y+=`fragShader:
${i.getShaderInfoLog(C)}
`,i.attachShader(x,C),i.linkProgram(x),i.useProgram(x),y+=i.getProgramInfoLog(x),!i.getProgramParameter(x,i.LINK_STATUS))throw`Could not compile WebGL program. 

${y}`;h.current=x,L.debug("program created"),s?.(i,x);const T=i.fenceSync(i.SYNC_GPU_COMMANDS_COMPLETE,0);return T&&(i.waitSync(T,0,i.TIMEOUT_IGNORED),r?.()),()=>{L.debug("cleaning up"),h.current=null,i.detachShader(x,S),i.detachShader(x,C),i.deleteShader(S),i.deleteShader(C),i.deleteProgram(x)}},[i,n,e]),v!=null&&i&&p.current){const x=p.current,S=v*window.devicePixelRatio*(g??1);x.width=S,x.height=S,i.viewport(0,0,S,S),l?.({width:S,height:S})}const d=h.current;return u.jsxs("div",{className:t,ref:f,children:[u.jsx("canvas",{ref:p,style:{width:v??void 0,height:v??void 0}},v),i&&d&&a&&u.jsx(a,{ctx:i,program:d})]})}function it({GLUniformsSetter:t,textureImage:e,textureName:n,variablesRef:a,className:o,vert:r,frag:s,onViewportUpdate:l,onRenderComplete:g,onGlAvailable:p,onCanvasSizeUpdate:h,scale:v}){const m=c.useRef(void 0),i=c.useCallback(async(f,d)=>{if(m.current=new t(f,d),e&&n){const x=f.createTexture();f.bindTexture(f.TEXTURE_2D,x),f.texParameteri(f.TEXTURE_2D,f.TEXTURE_WRAP_S,f.CLAMP_TO_EDGE),f.texParameteri(f.TEXTURE_2D,f.TEXTURE_WRAP_T,f.CLAMP_TO_EDGE),f.texParameteri(f.TEXTURE_2D,f.TEXTURE_MIN_FILTER,f.LINEAR),f.texParameteri(f.TEXTURE_2D,f.TEXTURE_MAG_FILTER,f.LINEAR),f.texImage2D(f.TEXTURE_2D,0,f.RGBA,f.RGBA,f.UNSIGNED_BYTE,e);const S=f.getUniformLocation(d,n);f.activeTexture(f.TEXTURE0),f.bindTexture(f.TEXTURE_2D,x),f.uniform1i(S,0)}p?.(f,d)},[t,e,n,p]),b=c.useRef(void 0),A=c.useCallback(()=>{m.current&&a.current&&m.current.setVariablesAndRender(a.current),b.current=requestAnimationFrame(A)},[a]);return c.useEffect(()=>(A(),()=>{b.current&&cancelAnimationFrame(b.current)}),[A]),u.jsx(at,{className:o,vert:r,frag:s,onViewportUpdate:l,onRenderComplete:g,onGlAvailable:i,onCanvasSizeUpdate:h,scale:v,Behaviors:()=>null})}const st="webp",rt=512,ct=512,lt="srgb",ut=3,dt="uchar",ft=72,mt=!1,vt=8,gt=!1,pt=!1,ht="{{.assetPrefix}}/assets/noise-watercolor-m3j88gni.webp",bt={format:st,width:rt,height:ct,space:lt,channels:ut,depth:dt,density:ft,isProgressive:mt,paletteBitDepth:vt,hasProfile:gt,hasAlpha:pt,src:ht};let ze;const W=new window.Image;W.crossOrigin="anonymous";W.src=bt.src;W.onload=()=>{ze=W};var xt=`#version 300 es
...
}`;class ce{#o;#s;#e;#a=[];#i={};#n;#t;static#r="BlorbUniformsObject";constructor(e,n){this.#e=e;const a=e.getUniformBlockIndex(n,ce.#r),o=e.getActiveUniformBlockParameter(n,a,e.UNIFORM_BLOCK_DATA_SIZE);this.#n=e.createBuffer(),e.bindBuffer(e.UNIFORM_BUFFER,this.#n),e.bufferData(e.UNIFORM_BUFFER,o,e.DYNAMIC_DRAW);const r=0;e.bindBufferBase(e.UNIFORM_BUFFER,r,this.#n),e.uniformBlockBinding(n,a,r);const s=e.getActiveUniformBlockParameter(n,a,e.UNIFORM_BLOCK_ACTIVE_UNIFORM_INDICES);this.#a=[],this.#i={};for(let l=0;l<s.length;l++){const g=s[l],p=e.getActiveUniform(n,g);if(!p)throw new Error("No uniformInfo for index "+g);let h=p.name;h=h.replace(/\[0\]$/,"");const v=e.getActiveUniforms(n,[g],e.UNIFORM_OFFSET)[0];this.#a.push(h),this.#i[h]=v}this.#t=new ArrayBuffer(o),this.#o=new Float32Array(this.#t),this.#s=new Int32Array(this.#t)}setVariablesAndRender(e){for(const n of this.#a){const[,a]=n.split("."),r=this.#i[n]/4,s=e[a];typeof s=="number"?this.#o[r]=s:typeof s=="boolean"?this.#s[r]=s?1:0:Array.isArray(s)&&this.#o.set(s,r)}this.#e.bindBuffer(this.#e.UNIFORM_BUFFER,this.#n),this.#e.bufferSubData(this.#e.UNIFORM_BUFFER,0,this.#t),this.#e.drawArrays(this.#e.TRIANGLE_STRIP,0,6)}}function w(t){const e=t.replace("#",""),n=parseInt(e.substring(0,2),16)/255,a=parseInt(e.substring(2,4),16)/255,o=parseInt(e.substring(4,6),16)/255;return new Float32Array([n,a,o])}const ae={BLUE:{bloopColorMain:w("#DCF7FF"),bloopColorLow:w("#0181FE"),bloopColorMid:w("#A4EFFF"),bloopColorHigh:w("#FFFDEF")},DARK_BLUE:{bloopColorMain:w("#DAF5FF"),bloopColorLow:w("#0066CC"),bloopColorMid:w("#2EC6F5"),bloopColorHigh:w("#72EAF5")},GREYSCALE:{bloopColorMain:w("#D7D7D7"),bloopColorLow:w("#303030"),bloopColorMid:w("#989898"),bloopColorHigh:w("#FFFFFF")},WHITE:{bloopColorMain:w("#FFFFFF"),bloopColorLow:w("#FFFFFF"),bloopColorMid:w("#FFFFFF"),bloopColorHigh:w("#FFFFFF")},BLACK:{bloopColorMain:w("#000000"),bloopColorLow:w("#000000"),bloopColorMid:w("#000000"),bloopColorHigh:w("#000000")}},At=t=>{const e=_e();return t?ae.BLUE:e?ae.WHITE:ae.BLACK},Ae=[300,300],yt={bands:4,loPass:0,hiPass:400},Ct=t=>{const e=n=>{let r=1-Math.max(-100,Math.min(-10,n))*-1/100;return r=Math.sqrt(r),r};return t.map(n=>n===-1/0?0:e(n))};function Le(t,e){const[n,a]=c.useState([]),o=c.useRef(void 0);return c.useEffect(()=>{if(!t)return;if(!o.current){const v=new AudioContext,m=v.createMediaElementSource(t),i=v.createAnalyser();m.connect(i),i.connect(v.destination),o.current={audioContext:v,mediaElementAudioSourceNode:m,analyserNode:i}}const{analyserNode:r,audioContext:s}=o.current,l=r?.frequencyBinCount??0,g=new Float32Array(l),h=setInterval(()=>{if(!r)return;r.getFloatFrequencyData(g);let v=g.slice(e.loPass,e.hiPass);const m=Ct(v),i=Math.ceil(m.length/e.bands),b=[];for(let A=0;A<e.bands;A++){const f=m.slice(A*i,(A+1)*i).reduce((d,x)=>d+x,0);b.push(f/i)}a(b)},e.updateInterval);return()=>{clearInterval(h),s&&s.close()}},[t,e.bands,e.hiPass,e.loPass,e.updateInterval]),n}const wt=t=>{const e=Le(t,{bands:se,updateInterval:G,loPass:0,hiPass:400,analyserOptions:{fftSize:Fe}});return e.length===0?Ee:e},_t=(t,e)=>{const n=wt(t),a=Pe(n,{sampleRate:Ie,binCount:e.bins,bandCount:e.bands,gainMultipliers:e.gainMultipliers}),o=re({magnitudes:n,binCount:1,gainMultiplier:1});return{bandMagnitudes:a,cumulativeMagnitude:o}},Tt=t=>{const[e,n]=c.useState({audioData:[0,0,0,0],cumulativeAudioData:[0,0,0,0]}),a=c.useRef([0,0,0,0]),o=c.useRef(void 0),r=c.useRef(performance.now()),{bandMagnitudes:s,cumulativeMagnitude:l}=_t(t,{bands:3,bins:1,gainMultipliers:[10,1,1]});a.current=[...s,l].flat();const g=c.useCallback(()=>{const p=performance.now(),h=(p-r.current)/1e3;r.current=p;const v=a.current,{audioData:m,cumulativeAudioData:i}=e,b=tt({deltaTimeS:h,audioDataRaw:v,prevAudioData:m,prevCumulativeAudioData:i});n(b)},[e]);return c.useEffect(()=>(o.current||(o.current=window.setInterval(g,G)),()=>{clearInterval(o.current),o.current=void 0}),[g]),e},ye=Promise.resolve();function Ne({url:t,readyToPlay:e}){const n=c.useRef(void 0),a=c.useRef(ye);return c.useEffect(()=>(n.current||(n.current=document.createElement("audio")),()=>{a.current.then(()=>{n.current&&(n.current.pause(),n.current.removeAttribute("src"),n.current.remove(),a.current=ye)})}),[]),c.useEffect(()=>{t&&n.current&&n.current.src!==t&&e&&a.current.then(()=>{n.current&&(n.current.crossOrigin="anonymous",n.current.src=t,a.current=n.current.play())})},[e,t]),n.current}function Dt({className:t,url:e}){const[n,a]=c.useState(!1),o=Ne({url:e,readyToPlay:n}),r=Le(o,yt),s=c.useMemo(()=>[0,0,0,0],[]);return u.jsx(Ue,{className:t,isAdvanced:!1,avgMag:r,cumulativeAudioData:s,onRenderComplete:()=>a(!0)})}function Mt({className:t,url:e}){const[n,a]=c.useState(!1),o=Ne({url:e,readyToPlay:n}),r=Tt(o),{audioData:s,cumulativeAudioData:l}=r;return u.jsx(Ue,{className:t,isAdvanced:!0,avgMag:s,cumulativeAudioData:l,onRenderComplete:()=>a(!0)})}const Ue=({className:t,avgMag:e,cumulativeAudioData:n,isAdvanced:a,onRenderComplete:o})=>{const r=_e(),s=c.useMemo(()=>performance.now()/1e3,[]),l=c.useMemo(()=>performance.now()/1e3,[]),g=c.useRef(void 0),[p,h]=c.useState(Ae),{canvasSizeRef:v,handleCanvasSizeUpdate:m}=wn(Ae),i=c.useCallback(S=>{h([S.width,S.height])},[]),[b,A]=c.useState(performance.now()/1e3);c.useEffect(()=>{const S=setInterval(()=>{A(performance.now()/1e3)},G);return()=>clearInterval(S)},[]);const f=At(a),d=kn({viewport:p,canvasSize:v.current,shouldMeasurePerf:!0,source:"VoicePicker"}),x=Pn({shouldCalibrate:!0,viewport:p,initialScale:1});return g.current={time:b,micLevel:0,stateListen:0,listenTimestamp:0,stateThink:0,thinkTimestamp:0,stateSpeak:1,speakTimestamp:l,readyTimestamp:s,stateHalt:0,haltTimestamp:0,touchDownTimestamp:0,touchUpTimestamp:0,stateFailedToConnect:0,failedToConnectTimestamp:0,avgMag:e,cumulativeAudio:n,isNewBloop:!0,isAdvancedBloop:a,bloopColorMain:Array.from(f.bloopColorMain),bloopColorLow:Array.from(f.bloopColorLow),bloopColorMid:Array.from(f.bloopColorMid),bloopColorHigh:Array.from(f.bloopColorHigh),isDarkMode:r,screenScaleFactor:window.devicePixelRatio,viewport:p,silenceAmount:0,silenceTimestamp:0,fadeBloopWhileListening:!1},u.jsx(it,{className:U("flex items-center justify-center",t),variablesRef:g,onViewportUpdate:i,onRenderComplete:o,textureImage:ze,textureName:"uTextureNoise",onGlAvailable:d,onCanvasSizeUpdate:m,scale:x,GLUniformsSetter:ce,vert:St,frag:xt})};function Rt({isUnauthenticated:t,loading:e,handleLoginClick:n,handleCancelClick:a,handleConfirmClick:o,selectedVoice:r,currentVoiceName:s,cameFromNux:l}){const g="w-52 whitespace-nowrap rounded-full px-20 py-3 font-semibold";return t?u.jsxs(u.Fragment,{children:[u.jsx(q,{className:U(g,"text-white"),onClick:n,children:e?u.jsx(me,{}):u.jsx(k,{id:"IRALWH",defaultMessage:"Log in"})}),u.jsx(q,{className:U(g,"text-black dark:text-white"),color:"ghost",onClick:a,children:u.jsx(k,{id:"8fumUc",defaultMessage:"Back to chat"})})]}):u.jsxs(u.Fragment,{children:[u.jsx(q,{className:U(g,"text-white"),onClick:o,children:e?u.jsx(me,{}):r?.voice===s&&!l?u.jsx(k,{id:"MyKAgb",defaultMessage:"Done"}):u.jsx(k,{id:"7+3LaJ",defaultMessage:"Start new chat"})}),u.jsx(q,{className:U(g,"text-black dark:text-white"),color:"ghost",onClick:a,children:u.jsx(k,{id:"dUn4Wd",defaultMessage:"Cancel"})})]})}const kt={offscreenLeft:{x:"-24rem",opacity:0},left:{x:"-12rem",opacity:.5},center:{x:"0",opacity:1},right:{x:"12rem",opacity:.5},offscreenRight:{x:"24rem",opacity:0}};function Bt({conversationId:t,onClose:e,cameFromNux:n=!1,initialVoiceName:a}){const{isUnauthenticated:o}=nn(),r=dn(),{voiceName:s}=Te(),l=fn(),[g,p]=c.useState(!1),h=ve.getGizmoId(ge(t)),[v,m]=c.useState(!1),[i,b]=c.useState(!1);c.useEffect(()=>{requestAnimationFrame(()=>m(!0))},[]);const[A,f]=c.useState(!1),[d,x]=c.useState(null);c.useEffect(()=>{if(l.length>0){const _=l.findIndex(z=>z.voice===(a||s));_>=0?x(_):x(2),f(!0)}},[l,s,a]);const S=d!=null?(d-2+l.length)%l.length:0,C=d!=null?(d-1+l.length)%l.length:1,y=d!=null?(d+1)%l.length:3,T=d!=null?(d+2)%l.length:4,D=l[d??0],F=l[S],H=l[C],B=l[y],X=l[T],E=_=>{x(_)},{stopVoiceMode:K,startVoiceMode:O}=Mn({requestMicPermissions:n}),{setValue:P}=gn(tn.VoiceName),V=Me(_=>_.voiceMode),I=n&&!h?"advanced":V,$=c.useCallback(()=>{b(!n),setTimeout(()=>{const _=d!=null?l[d]?.voice:l[0]?.voice;sessionStorage.setItem("selectedVoiceName",_),r({authType:"login",callback:z=>{on.logLogInButtonClicked({provider:z,location:"Voice Picker Page"})}})},Q)},[n,r,d,l]),Y=c.useCallback(async()=>{b(!n),setTimeout(async()=>{p(!0);const _=d!=null?l[d]?.voice:l[0]?.voice;if(n||_!==s){n||R.voiceSelected.click({action:"changed",voice:_}),P(_),await K(),mn("/");try{await O({conversation_id:void 0,eventSource:"voice_picker",voice_mode:I,voice:_,clientThreadId:an(),gizmo_id:ve.getGizmoId(ge(t))})}catch(z){sn.addError(`Failed to start voice mode after voice picker: ${z}`)}}else R.voiceSelected.click({action:"kept",voice:s});p(!1),e()},Q)},[n,t,s,e,d,P,O,K,I,l]),M=()=>{b(!0),setTimeout(e,Q)};_n({setSelectedVoiceIndex:x,prevVoiceIndex:C,nextVoiceIndex:y});const[j,le]=c.useState(!1),ue=_=>{_==="prev"?E(C):_==="next"&&E(y),le(!0),setTimeout(()=>{le(!1)},175)},de=c.useMemo(()=>({className:"h-max min-h-bloop w-max min-w-bloop",url:D?.preview_url}),[D?.preview_url]);return!A||d==null?u.jsx("div",{className:"fixed left-0 top-0 z-50 flex h-full w-full bg-token-main-surface-primary"}):u.jsxs("div",{className:`fixed left-0 top-0 z-50 flex h-full w-full flex-col items-center justify-center bg-white transition-opacity duration-300 dark:bg-gray-800 ${v&&!i?"opacity-100":"opacity-0"}`,children:[u.jsx("h1",{className:"mb-8 mt-36 text-3xl font-semibold",children:o?u.jsx(k,{id:"P4GR/e",defaultMessage:"Try voice mode for free"}):u.jsx(k,{id:"2whyE9",defaultMessage:"Choose a voice"})}),u.jsx("div",{className:"flex h-full w-full items-center justify-center",children:D?n&&!h||I==="advanced"?u.jsx(Mt,{...de}):u.jsx(Dt,{...de}):null}),u.jsx("div",{className:"mb-8 flex items-center justify-between text-center",children:u.jsxs("div",{className:"relative flex h-24 w-48",children:[u.jsx(N,{voice:F,variant:"offscreenLeft"},F?.name),u.jsx(N,{voice:H,variant:"left",onClick:()=>E(C)},H?.name),u.jsx(Ce,{direction:"prev",onClick:()=>ue("prev"),isFading:j}),u.jsx(N,{voice:D,variant:"center"},D?.name),u.jsx(Ce,{direction:"next",onClick:()=>ue("next"),isFading:j}),u.jsx(N,{voice:B,variant:"right",onClick:()=>E(y)},B?.name),u.jsx(N,{voice:X,variant:"offscreenRight"},X?.name),u.jsx("div",{className:"pointer-events-none absolute h-full w-full -translate-x-52 transform bg-gradient-to-r from-[var(--main-surface-background)] to-transparent"}),u.jsx("div",{className:"pointer-events-none absolute h-full w-full translate-x-52 transform bg-gradient-to-l from-[var(--main-surface-background)] to-transparent"}),u.jsx("div",{className:"pointer-events-none absolute h-full w-full -translate-x-96 transform bg-white dark:bg-gray-800"}),u.jsx("div",{className:"pointer-events-none absolute h-full w-full translate-x-96 transform bg-white dark:bg-gray-800"})]})}),u.jsx("div",{className:"mb-36 flex flex-col space-y-3",children:u.jsx(Rt,{isUnauthenticated:o,loading:g,handleLoginClick:$,handleCancelClick:M,handleConfirmClick:Y,selectedVoice:D,currentVoiceName:s,cameFromNux:n})})]})}function N({voice:t,variant:e,onClick:n}){return u.jsxs(Oe.button,{onClick:n,className:"absolute flex w-48 select-none flex-col items-center justify-center",variants:kt,animate:e,initial:e,transition:{duration:.25,ease:"easeInOut"},children:[u.jsx("p",{className:`text-lg ${e==="center"?"font-semibold":""}`,children:t?.name}),u.jsx("p",{className:"text-sm text-gray-600 dark:text-[var(--text-secondary)]",children:t?.description})]})}function Ce({direction:t,onClick:e,isFading:n}){const a=t==="prev"?vn:rn,o=we(),r=t==="prev"?o.formatMessage({id:"ajuz05",defaultMessage:"Previous voice"}):o.formatMessage({id:"Dr8wrw",defaultMessage:"Next voice"});return u.jsx("button",{className:`duration-175 absolute ${t==="prev"?"-left-4":"-right-4"} top-2 z-50 transition-opacity ${n?"opacity-20":"opacity-100"}`,onClick:e,"aria-label":r,children:u.jsx(a,{className:"h-6 w-6 text-token-text-quaternary hover:text-token-text-secondary"})})}export{G as B,it as G,Bt as V,Tn as a,Dn as b,Ut as c,At as d,kn as e,Pn as f,Nt as g,ce as h,xt as i,ze as n,tt as s,Mn as u,St as v};
//# sourceMappingURL=n2tebdetu1xczkux.js.map
